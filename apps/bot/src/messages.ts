...
export function sourceStartMessage() {
  return [
    "Создадим обложку.",
    "",
    "Просто пришлите то, что у вас есть:",
    "— ссылку на опубликованный ролик;",
    "— видеофайл;",
    "— текст, сценарий или описание ролика.",
    "",
    "Я сам определю тип материала и перейду к следующему шагу."
  ].join("\n");
}
