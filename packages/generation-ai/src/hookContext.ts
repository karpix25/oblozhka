...
const STOP_WORDS = new Set([
  ...
  "этот", "этого", "этой", "более", "будет", "быть", "ваш", "ваши", "весь", "вот",
  "даже", "есть", "когда", "который", "может", "можно", "нужно", "один", "очень",
  "свои", "свой", "своё", "также", "только", "через", "the", "and", "for", "you"
]);
